...
|---|---|---|---|
| PRD-001 / CALC-001 | calculation-engine.md | analytics-core/calculation.ts | control finding rate + zero denominator, implemented |
...
| WIDGET-001 / PRD-007 | widget-specification.md | widget-generator.ts + DqiAuditStudio.tsx | prompt/query/visual flow, implemented |
